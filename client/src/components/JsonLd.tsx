...
export const BUSINESS_JSON_LD = {
  ...
  priceRange: "$$",
  description:
    "Professional house cleaning across Los Angeles / Orange County, Las Vegas / Nevada, and Sacramento. Background-checked cleaners, documented checklists, 4.9★ with 370+ Google reviews.",
  areaServed: [
    {
